...
/**
 * A soccer-ball vector graphic (source: Twemoji, CC-BY 4.0), built directly from SVG path data
 * via Compose's ImageVector API — no rasterization tooling needed, renders identically on
 * Android and iOS. Same source used for the Android adaptive launcher icon
 * (androidApp/src/main/res/drawable-v24/ic_launcher_foreground.xml).
 */
val BallLogo: ImageVector by lazy {
    ImageVector.Builder(
        name = "BallLogo",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
...
@Composable
fun BallLogoImage(modifier: Modifier = Modifier) {
    Image(
        painter = rememberVectorPainter(BallLogo),
